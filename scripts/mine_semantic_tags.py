...
TAGS: list[dict] = [
    ...
    _lemma(
        ...
        "Dog",
        "animals",
        ["dog", "dogs", "puppy", "puppies", "bitch", "mongrel", "cur"],
        parent="animal",
        extra_patterns=[
            r"\bcanine\b",
            r"\baləmoss\b",  # sometimes left in English notes
        ],
        headword_patterns=[
            r"aləmoss",  # áləmoss dog stem family
            r"aləmohč",  # mongrel
            # dog compounds often end in -ahsəm / -ehsəm (matahsəm, napehsəm, skwehsəm…)
            r"ahsəm$",
            r"ehsəm$",
            r"ahsəmohs",
            r"ehsəmohs",
        ],
        exclude=[r"\bsun dog\b", r"\bcanine tooth\b", r"\bdog-tooth\b", r"\bdogberry\b"],
        description="Dogs and dog-specific vocabulary",
        confidence="high",
    ),
    _theme(
        "dog_talk",
        ...
        "animals",
        [
            r"spoken only to a dog",
            r"said only to a dog",
            r"\[spoken only to a dog\]",
            r"go away \(dog\)",
            r"get out \(dog\)",
            r"come here,?\s*dog",
            r"onomatopoeia for bark of dog",
            r"bow-wow",
            r"\[dog speaking\]",
            r"dog speaking",
        ],
        keywords=["bow-wow", "dog", "come here"],
        headword_patterns=[
            r"ččə̀wis",
            r"ččəwis",
            r"^kə̀ssa$",
        ...
        description="Commands and speech used only with dogs (come here / go away / bark sound)",
        confidence="high",
    ),
    _theme(
        "animal_sound",
        ...
        "animals",
        [
            # avoid bare "bark" — that is tree bark in this dictionary
            r"\bbarks\b", r"\bbarking\b", r"\bbark at\b", r"\bto bark\b", r"\bof barking\b",
            r"\bhe barks\b", r"\bis barking\b", r"\bsound of barking\b",
            r"\bhowls\b", r"\bhowling\b", r"\bhe howls\b", r"\bwind howls\b",
            r"\bwhines\b", r"\bwhining\b", r"\bhe \(dog\) whines\b", r"\bwhines \[animal",
            r"\bgrowls\b", r"\bgrowling\b", r"\bhe growls\b",
            r"\bchatters\b", r"\bchattering\b",
            r"\bonomatopoeia for bark\b", r"\bbow-wow\b",
            r"\bmakes a .+ call\b", r"\bcalls like\b", r"\bmoose call\b",
        ],
        keywords=["barks", "barking", "howl", "howls", "whine", "whines", "growl", "growls", "bow-wow"],
        headword_patterns=[r"\|wəki-\|", r"wə̀kihke", r"wəkihke"],
        exclude=[
            r"\bbirch bark\b", r"\bcedar bark\b", r"\bfir bark\b", r"\bfir tree bark\b",
            r"\bof bark\b", r"\bpeels? bark\b", r"\bbark for canoe\b", r"\bbark canoe\b",
            r"\bbark house\b", r"\bbark lodge\b", r"\bbark stream\b", r"\bstrip of .+ bark\b",
            r"\bwar whoop\b", r"\bwar-whoop\b", r"\bwar cry\b",
        ],
        description="Barks, howls, whines, growls, animal calls (not tree bark)",
    ),
