...
def build_about_page(meta: dict) -> str:
    ...
    <section class="about-section">
      <h2>Source code</h2>
      <p>This site is open source. Anyone may clone it, host their own mirror, or adapt it for community use:</p>
      <p><a href="https://github.com/Inphidel/penobscot-dictionary" target="_blank" rel="noopener">github.com/Inphidel/penobscot-dictionary</a></p>
      <pre class="code-block">git clone https://github.com/Inphidel/penobscot-dictionary.git
cd penobscot-dictionary
# serve the ready-made site/ folder (nginx, Apache, or python -m http.server)</pre>
      <p class="muted">Dictionary text and recordings remain credited to the Penobscot Indian Nation, University of Maine, and American Philosophical Society. Lab tools and Games are optional study aids in this package.</p>
    </section>
